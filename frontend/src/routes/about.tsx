...
function About() {
  return (
    <div className="p-5 flex items-center justify-center">
      <div className="max-w-3xl bg-gradient-to-br from-blue-50 to-indigo-100 shadow-md rounded-lg p-6">
        <h1 className="text-3xl font-bold  text-indigo-800 text-center mb-4">📘 About BCIT TaskMate</h1>
        ...
        <p className="mt-6 text-center text-indigo-600 font-semibold">Organize, focus, and succeed with BCIT TaskMate!</p>
      </div>
    </div>
  );
}
